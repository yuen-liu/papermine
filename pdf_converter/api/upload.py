...
def upload_pdf():
    ...
    try:
        ...
        return jsonify({
            ...
            'nlp': {
                'summary': 'PDF processed successfully on Vercel',
                'keywords': ['pdf', 'converted', 'success', 'vercel']
            }
        })
...
def health_check():
    return jsonify({'status': 'healthy', 'message': 'PDF Converter API is running on Vercel!'})
